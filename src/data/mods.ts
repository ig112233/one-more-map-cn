...
const adjacentImplicits: VoyageModDef[] = [
  ...
  { id: 'adj-msg-1', short: '+1 信息', text: 'Adjacent Areas contain an additional Message in a Bottle', zh: '相邻区域额外包含 1 个瓶中信息', aliases: ['相鄰區域內含有額外 1 個瓶中信', '相邻区域包含 1 个额外瓶中信', '相邻区域包含一个额外瓶中信'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 12 }] },
  { id: 'adj-msg-2', short: '+2 信息', text: 'Adjacent Areas contain 2 additional Messages in Bottles', zh: '相邻区域额外包含 2 个瓶中信息', aliases: ['相鄰區域內含有額外 2 個瓶中信', '相邻区域包含 2 个额外瓶中信'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 22 }] },
  ...
  { id: 'adj-divbox-1', short: '+2 预言家保险箱', text: "Adjacent Areas contain 2 additional Diviner's Strongboxes", zh: "相邻区域额外包含 2 个预言家保险箱", aliases: ['인접 지역들에 예언자의 금고 2개 추가 등장', '相鄰區域內含有額外 2 個命運的保險箱', '相邻区域包含 2 个额外神圣的秘宝'], scope: 'adjacent', effects: [{ stat: 'divcards', percent: 45 }] },
  { id: 'adj-divbox-2', short: '+3 预言家保险箱', text: "Adjacent Areas contain 3 additional Diviner's Strongboxes", zh: "相邻区域额外包含 3 个预言家保险箱", aliases: ['인접 지역들에 예언자의 금고 3개 추가 등장', '相鄰區域內含有額外 3 個命運的保險箱', '相邻区域包含 3 个额外神圣的秘宝'], scope: 'adjacent', effects: [{ stat: 'divcards', percent: 65 }] },
  { id: 'adj-arcbox-1', short: '+2 秘术家保险箱', text: "Adjacent Areas contain 2 additional Arcanist's Strongboxes", zh: "相邻区域额外包含 2 个秘术家保险箱", aliases: ['인접 지역들에 신비학자의 금고 2개 추가 등장', '相鄰區域內含有額外 2 個奧術師的保險箱', '相邻区域包含 2 个额外奥术师的保险箱'], scope: 'adjacent', effects: [{ stat: 'currency', percent: 40 }] },
  { id: 'adj-arcbox-2', short: '+3 秘术家保险箱', text: "Adjacent Areas contain 3 additional Arcanist's Strongboxes", zh: "相邻区域额外包含 3 个秘术家保险箱", aliases: ['인접 지역들에 신비학자의 금고 3개 추가 등장', '相鄰區域內含有額外 3 個奧術師的保險箱', '相邻区域包含 3 个额外奥术师的保险箱'], scope: 'adjacent', effects: [{ stat: 'currency', percent: 55 }] },
  { id: 'adj-opbox-1', short: '+2 特工保险箱', text: "Adjacent Areas contain 2 additional Operative's Strongboxes", zh: "相邻区域额外包含 2 个特工保险箱", aliases: ['인접 지역들에 첩보원의 금고 2개 추가 등장', '相鄰區域內含有額外 2 個特工的保險箱', '相邻区域包含 2 个额外侦探的保险箱'], scope: 'adjacent', effects: [{ stat: 'scarabs', percent: 40 }] },
  { id: 'adj-opbox-2', short: '+3 特工保险箱', text: "Adjacent Areas contain 3 additional Operative's Strongboxes", zh: "相邻区域额外包含 3 个特工保险箱", aliases: ['인접 지역들에 첩보원의 금고 3개 추가 등장', '相鄰區域內含有額外 3 個特工的保險箱', '相邻区域包含 3 个额外侦探的保险箱'], scope: 'adjacent', effects: [{ stat: 'scarabs', percent: 55 }] },
  {
    id: 'adj-barrel-1',
    short: '+12-15 木桶',
