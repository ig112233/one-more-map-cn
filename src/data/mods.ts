...
const adjacentImplicits: VoyageModDef[] = [
  { id: 'adj-ess-1', short: '+1-2 囚禁', text: 'Adjacent Areas contain 1-2 additional Imprisoned Monsters', zh: '相邻区域额外包含 1-2 个被囚禁的怪物', aliases: ['인접 지역들에 갇힌 몬스터 1(1-2)마리 추가 등장', '相鄰區域內含有額外 (1—2) 名被禁錮的怪物'], scope: 'adjacent', effects: [{ stat: 'essences', percent: 15 }] },
  { id: 'adj-ess-2', short: '+2-4 囚禁', text: 'Adjacent Areas contain 2-4 additional Imprisoned Monsters', zh: '相邻区域额外包含 2-4 个被囚禁的怪物', aliases: ['인접 지역들에 갇힌 몬스터 4(2-4)마리 추가 등장', '相鄰區域內含有額外 (2—4) 名被禁錮的怪物'], scope: 'adjacent', effects: [{ stat: 'essences', percent: 30 }] },
  { id: 'adj-ess-3', short: '+5 囚禁', text: 'Adjacent Areas contain 5 additional Imprisoned Monsters', zh: '相邻区域额外包含 5 个被囚禁的怪物', aliases: ['인접 지역들에 갇힌 몬스터 5마리 추가 등장', '相鄰區域內含有額外 5 名被禁錮的怪物'], scope: 'adjacent', effects: [{ stat: 'essences', percent: 50 }] },
  { id: 'adj-box-1', short: '+1 保险箱', text: 'Adjacent Areas contain an additional Strongbox', zh: '相邻区域额外包含 1 个保险箱', aliases: ['인접 지역들에 금고 1개 추가 등장', '相鄰區域內含有額外 1 個保險箱'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 15 }] },
  { id: 'adj-box-2', short: '+2-4 保险箱', text: 'Adjacent Areas contain 2-4 additional Strongboxes', zh: '相邻区域额外包含 2-4 个保险箱', aliases: ['인접 지역들에 금고 3(2-4)개 추가 등장', '相鄰區域內含有額外 (2—4) 個保險箱'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 35 }] },
  { id: 'adj-box-3', short: '+5 保险箱', text: 'Adjacent Areas contain 5 additional Strongboxes', zh: '相邻区域额外包含 5 个保险箱', aliases: ['인접 지역들에 금고 5개 추가 등장', '相鄰區域內含有額外 5 個保險箱'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 55 }] },
  {
    id: 'adj-octo-1',
    short: '+8-10 章鱼',
  ...
  { id: 'adj-crab-1', short: '+8-10 螃蟹', text: 'Adjacent Areas contain 8-10 additional packs of Crabs', zh: '相邻区域额外包含 8-10 群螃蟹', aliases: ['인접 지역에 게 무리 8(8-10)개 추가 등장', '相鄰區域內含有額外(8—10)群螃蟹'], scope: 'adjacent', effects: [{ stat: 'packsize', percent: 25 }] },
  { id: 'adj-crab-2', short: '+11-14 螃蟹', text: 'Adjacent Areas contain 11-14 additional packs of Crabs', zh: '相邻区域额外包含 11-14 群螃蟹', aliases: ['인접 지역에 게 무리 11(11-14)개 추가 등장', '相鄰區域內含有額外(11—14)群螃蟹'], scope: 'adjacent', effects: [{ stat: 'packsize', percent: 35 }] },
  ...
  { id: 'adj-msg-1', short: '+1 信息', text: 'Adjacent Areas contain an additional Message in a Bottle', zh: '相邻区域额外包含 1 个瓶中信息', aliases: ['相鄰區域內含有額外 1 個瓶中信'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 12 }] },
  { id: 'adj-msg-2', short: '+2 信息', text: 'Adjacent Areas contain 2 additional Messages in Bottles', zh: '相邻区域额外包含 2 个瓶中信息', aliases: ['相鄰區域內含有額外 2 個瓶中信'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 22 }] },
  { id: 'adj-fish', short: '珍稀鱼类', text: 'Adjacent Areas contain highly prized and exotic Fish', zh: '相邻区域包含备受珍视的珍稀鱼类', aliases: ['相鄰區域內含有高價且珍稀的魚類'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 20 }] },
  ...
  { id: 'adj-atziri', short: '阿兹里的影响', text: "Atziri's Influence", zh: "阿兹里的影响", aliases: ['앗지리의 영향력', '阿茲里之息'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 40 }] },
  {
    id: 'adj-gold-1',
    text: '40% of Equipment dropped by Monsters in Area is converted to Gold',
    zh: '区域内怪物掉落的装备有 40% 转化为金币',
    aliases: ['인접 지역 내 몬스터가 떨어뜨리는 장비의 40%가 골드로 전환', '相鄰區域內的怪物掉落的裝備有 40% 會改為掉落金幣'],
    scope: 'adjacent',
    effects: [{ stat: 'gold', percent: 40 }],
  },
  { id: 'adj-gold-2', text: '80% of Equipment dropped by Monsters in Area is converted to Gold', zh: '区域内怪物掉落的装备有 80% 转化为金币', aliases: ['인접 지역 내 몬스터가 떨어뜨리는 장비의 80%가 골드로 전환', '相鄰區域內的怪物掉落的裝備有 80% 會改為掉落金幣'], scope: 'adjacent', effects: [{ stat: 'gold', percent: 80 }] },
  { id: 'adj-spirit-1', short: '+1 幽魂牢笼', text: 'Adjacent Areas contain an additional cage of Tormented Spirits', zh: '相邻区域额外包含 1 个折磨之灵牢笼', aliases: ['인접 지역들에 고통받는 혼백의 창살 1개 추가 등장', '相邻区域包含一个额外罪魂牢笼', '相鄰區域內含有額外 1 個關滿罪魂的囚牢'], scope: 'adjacent', effects: [{ stat: 'spirits', percent: 20 }] },
  { id: 'adj-spirit-2', short: '+2 幽魂牢笼', text: 'Adjacent Areas contain 2 additional cages of Tormented Spirits', zh: '相邻区域额外包含 2 个折磨之灵牢笼', aliases: ['인접 지역들에 고통받는 혼백의 창살 2개 추가 등장', '相鄰區域內含有額外 2 個關滿罪魂的囚牢'], scope: 'adjacent', effects: [{ stat: 'spirits', percent: 38 }] },
  { id: 'adj-divbox-1', short: '+2 预言家保险箱', text: "Adjacent Areas contain 2 additional Diviner's Strongboxes", zh: "相邻区域额外包含 2 个预言家保险箱", aliases: ['인접 지역들에 예언자의 금고 2개 추가 등장', '相鄰區域內含有額外 2 個命運的保險箱'], scope: 'adjacent', effects: [{ stat: 'divcards', percent: 45 }] },
  { id: 'adj-divbox-2', short: '+3 预言家保险箱', text: "Adjacent Areas contain 3 additional Diviner's Strongboxes", zh: "相邻区域额外包含 3 个预言家保险箱", aliases: ['인접 지역들에 예언자의 금고 3개 추가 등장', '相鄰區域內含有額外 3 個命運的保險箱'], scope: 'adjacent', effects: [{ stat: 'divcards', percent: 65 }] },
  { id: 'adj-arcbox-1', short: '+2 秘术家保险箱', text: "Adjacent Areas contain 2 additional Arcanist's Strongboxes", zh: "相邻区域额外包含 2 个秘术家保险箱", aliases: ['인접 지역들에 신비학자의 금고 2개 추가 등장', '相鄰區域內含有額外 2 個奧術師的保險箱'], scope: 'adjacent', effects: [{ stat: 'currency', percent: 40 }] },
  { id: 'adj-arcbox-2', short: '+3 秘术家保险箱', text: "Adjacent Areas contain 3 additional Arcanist's Strongboxes", zh: "相邻区域额外包含 3 个秘术家保险箱", aliases: ['인접 지역들에 신비학자의 금고 3개 추가 등장', '相鄰區域內含有額外 3 個奧術師的保險箱'], scope: 'adjacent', effects: [{ stat: 'currency', percent: 55 }] },
  { id: 'adj-opbox-1', short: '+2 特工保险箱', text: "Adjacent Areas contain 2 additional Operative's Strongboxes", zh: "相邻区域额外包含 2 个特工保险箱", aliases: ['인접 지역들에 첩보원의 금고 2개 추가 등장', '相鄰區域內含有額外 2 個特工的保險箱'], scope: 'adjacent', effects: [{ stat: 'scarabs', percent: 40 }] },
  { id: 'adj-opbox-2', short: '+3 特工保险箱', text: "Adjacent Areas contain 3 additional Operative's Strongboxes", zh: "相邻区域额外包含 3 个特工保险箱", aliases: ['인접 지역들에 첩보원의 금고 3개 추가 등장', '相鄰區域內含有額外 3 個特工的保險箱'], scope: 'adjacent', effects: [{ stat: 'scarabs', percent: 55 }] },
  {
    id: 'adj-barrel-1',
    short: '+12-15 木桶',
  ...
  },
  {
    ...
    aliases: ['인접 지역들에 에 거대 불가사리 4(4-5)마리 추가 등장', '相鄰區域內含有額外(4—5)群巨大海星'],
    scope: 'adjacent',
    effects: [{ stat: 'packsize', percent: 15 }],
  },
  { id: 'adj-star-2', short: '+6-7 海星', text: 'Adjacent Areas contains 6-7 additional Giant Starfish', zh: '相邻区域额外包含 6-7 只巨型海星', aliases: ['인접 지역들에 에 거대 불가사리 7(6-7)마리 추가 등장', '相鄰區域內含有額外(6—7)群巨大海星'], scope: 'adjacent', effects: [{ stat: 'packsize', percent: 20 }] },
  ...
  { id: 'adj-lantern', short: '+4 黄金灯笼', text: 'Adjacent Areas contain 4 additional Golden Lanterns', zh: '相邻区域额外包含 4 个黄金灯笼', aliases: ['인접 지역들에 황금 등불 4개 추가 등장', '相鄰區域內含有額外 4 個黃金燈籠'], scope: 'adjacent', effects: [{ stat: 'treasure', percent: 20 }] },
  { id: 'adj-pantheon', short: '万神殿稀有怪', text: 'Rare Monsters in adjacent Areas will have a Pantheon Modifier', zh: '相邻区域的稀有怪物将拥有 1 个万神殿词缀', aliases: ['인접 지역들 내 희귀 몬스터가 판테온 속성 1개 보유', '相鄰區域內的稀有怪物擁有一條眾神殿詞綴'], scope: 'adjacent', effects: [{ stat: 'rares', percent: 25 }] },
  { id: 'adj-uring-1', short: '10% 暗金戒指', text: 'Rings dropped in adjacent Areas have 10% chance to instead drop as a Unique Ring', zh: '相邻区域掉落的戒指有 10% 几率改为掉落暗金戒指', aliases: ['인접 지역들에서 떨어지는 반지가 10% 확률로 고유 반지로 떨어짐', '相鄰區域內掉落的戒指有 10% 機率改為掉落一個傳奇戒指'], scope: 'adjacent', effects: [{ stat: 'uniques', percent: 20 }] },
  { id: 'adj-uring-2', short: '20% 暗金戒指', text: 'Rings dropped in adjacent Areas have 20% chance to instead drop as a Unique Ring', zh: '相邻区域掉落的戒指有 20% 几率改为掉落暗金戒指', aliases: ['인접 지역들에서 떨어지는 반지가 20% 확률로 고유 반지로 떨어짐', '相鄰區域內掉落的戒指有 20% 機率改為掉落一個傳奇戒指'], scope: 'adjacent', effects: [{ stat: 'uniques', percent: 40 }] },
  { id: 'adj-uamu-1', short: '10% 暗金项链', text: 'Amulets dropped in adjacent Areas have 10% chance to instead drop as a Unique Amulet', zh: '相邻区域掉落的项链有 10% 几率改为掉落暗金项链', aliases: ['인접 지역들에서 떨어지는 목걸이가 10% 확률로 고유 목걸이로 떨어짐', '相鄰區域內掉落的項鍊有 10% 機率改為掉落一條傳奇項鍊'], scope: 'adjacent', effects: [{ stat: 'uniques', percent: 20 }] },
  { id: 'adj-uamu-2', short: '20% 暗金项链', text: 'Amulets dropped in adjacent Areas have 20% chance to instead drop as a Unique Amulet', zh: '相邻区域掉落的项链有 20% 几率改为掉落暗金项链', aliases: ['인접 지역들에서 떨어지는 목걸이가 20% 확률로 고유 목걸이로 떨어짐', '相鄰區域內掉落的項鍊有 20% 機率改為掉落一條傳奇項鍊'], scope: 'adjacent', effects: [{ stat: 'uniques', percent: 40 }] },
  { id: 'adj-ubelt-1', short: '10% 暗金腰带', text: 'Belts dropped in adjacent Areas have 10% chance to instead drop as a Unique Belt', zh: '相邻区域掉落的腰带有 10% 几率改为掉落暗金腰带', aliases: ['인접 지역들에서 떨어지는 허리띠가 10% 확률로 고유 허리띠로 떨어짐', '相鄰區域內掉落的腰帶有 10% 機率改為掉落一條傳奇腰帶'], scope: 'adjacent', effects: [{ stat: 'uniques', percent: 20 }] },
  { id: 'adj-ubelt-2', short: '20% 暗金腰带', text: 'Belts dropped in adjacent Areas have 20% chance to instead drop as a Unique Belt', zh: '相邻区域掉落的腰带有 20% 几率改为掉落暗金腰带', aliases: ['인접 지역들에서 떨어지는 허리띠가 20% 확률로 고유 허리띠로 떨어짐', '相鄰區域內掉落的腰帶有 20% 機率改為掉落一條傳奇腰帶'], scope: 'adjacent', effects: [{ stat: 'uniques', percent: 40 }] },
]
...
const voyageImplicits: VoyageModDef[] = [
  { id: 'voy-soul', short: '噬魂者', text: 'Players in Area have Soul Eater', zh: '区域内的玩家拥有噬魂者', aliases: ['모든 항해 지역 내 플레이어들이 영혼 포식자 획득', '玩家在航程中所有區域時擁有噬魂者'], scope: 'global', effects: [] },
  { id: 'voy-pack-1', text: '5% increased Pack size', zh: '怪物群规模增加 5%', aliases: ['모든 항해 지역 내 무리 규모 5% 증가', '增加 5% 航程中所有區域的怪物群大小'], scope: 'global', effects: [{ stat: 'packsize', percent: 5 }] },
  { id: 'voy-pack-2', text: '7% increased Pack size', zh: '怪物群规模增加 7%', aliases: ['모든 항해 지역 내 무리 규모 7% 증가', '增加 7% 航程中所有區域的怪物群大小'], scope: 'global', effects: [{ stat: 'packsize', percent: 7 }] },
  { id: 'voy-quant-1', text: '8% increased Quantity of Items found in this Area', zh: '此区域发现的物品数量增加 8%', aliases: ['모든 항해 지역에서 발견하는 아이템 수량 8% 증가', '增加 8% 航程中所有區域找到的物品數量'], scope: 'global', effects: [{ stat: 'quantity', percent: 8 }] },
  { id: 'voy-quant-2', text: '10% increased Quantity of Items found in this Area', zh: '此区域发现的物品数量增加 10%', aliases: ['모든 항해 지역에서 발견하는 아이템 수량 10% 증가', '增加 10% 航程中所有區域找到的物品數量'], scope: 'global', effects: [{ stat: 'quantity', percent: 10 }] },
  { id: 'voy-rarity-1', text: '7% increased Rarity of Items found in this Area', zh: '此区域发现的物品稀有度增加 7%', aliases: ['모든 항해 지역에서 발견하는 아이템 희귀도 7% 증가', '增加 7% 航程中所有區域找到的物品稀有度'], scope: 'global', effects: [{ stat: 'rarity', percent: 7 }] },
  { id: 'voy-rarity-2', text: '9% increased Rarity of Items found in this Area', zh: '此区域发现的物品稀有度增加 9%', aliases: ['모든 항해 지역에서 발견하는 아이템 희귀도 9% 증가', '增加 9% 航程中所有區域找到的物品稀有度'], scope: 'global', effects: [{ stat: 'rarity', percent: 9 }] },
  { id: 'voy-jelly', short: '友善水母', text: 'All Voyage Areas contain Friendly Jellyfish', zh: '所有航行区域包含友善水母', aliases: ['지역에 살가운 해파리 등장', '相鄰區域內含有一隻友善的水母'], scope: 'global', effects: [] },
  { id: 'voy-sulph-1', text: "15% increased Dead Man's Sulphur found in this Area", zh: '此区域发现的亡者硫磺增加 15%', aliases: ['모든 항해 지역에서 발견하는 망자의 유황 15% 증가', '增加 15% 航程中所有區域內找到的亡者硫酸'], scope: 'global', effects: [{ stat: 'sulphur', percent: 15 }] },
  { id: 'voy-sulph-2', text: "20% increased Dead Man's Sulphur found in this Area", zh: '此区域发现的亡者硫磺增加 20%', aliases: ['모든 항해 지역에서 발견하는 망자의 유황 20% 증가', '增加 20% 航程中所有區域內找到的亡者硫酸'], scope: 'global', effects: [{ stat: 'sulphur', percent: 20 }] },
  { id: 'voy-sulph-3', text: "25% increased Dead Man's Sulphur found in this Area", zh: '此区域发现的亡者硫磺增加 25%', aliases: ['모든 항해 지역에서 발견하는 망자의 유황 25% 증가', '增加 25% 航程中所有區域內找到的亡者硫酸'], scope: 'global', effects: [{ stat: 'sulphur', percent: 25 }] },
  ...
  { id: 'voy-magic', text: '25% increased Magic Monsters', zh: '魔法怪物数量增加 25%', aliases: ['모든 항해 지역 내 마법 몬스터 수 25% 증가', '增加 25% 航程中所有區域找到的魔法怪物數量'], scope: 'global', effects: [{ stat: 'magicmonsters', percent: 25 }] },
  { id: 'voy-noequip', short: '不掉落装备', text: 'Monsters in all Voyage Areas cannot drop Equipment, Flasks or Tinctures', zh: '所有航行区域的怪物不会掉落装备、药剂或酊剂', aliases: ['怪物無法掉落裝備、藥劑、或萃取物'], scope: 'global', effects: [] },
  { id: 'voy-minmagic', short: '至少为魔法', text: 'Monsters in Area are at least Magic', zh: '区域内的怪物至少为魔法等级', aliases: ['모든 항해 지역 내 몬스터가 마법 이상으로 등장', '航程中所有區域的所有怪物為魔法'], scope: 'global', effects: [{ stat: 'magicmonsters', percent: 30 }] },
  { id: 'voy-possess', short: '稀有怪被附身', text: '100% chance for Rare Monsters in Area to be Possessed', zh: '区域内的稀有怪物有 100% 几率被附身', aliases: ['모든 항해 지역 내 희귀 몬스터가 100%의 확률로 사로잡힘', '航程中所有區域的稀有怪物有 100% 機率被附身'], scope: 'global', effects: [{ stat: 'spirits', percent: 100 }] },
  { id: 'voy-essence', short: '稀有怪被精髓囚禁', text: 'Rare monsters that are natural inhabitants are imprisoned by Essences', zh: '区域内的稀有怪物被精髓囚禁', aliases: ['모든 항해 지역 내 자연적으로 서식하는 희귀 몬스터가 에센스에 갇힘', '航程中所有區域的原生稀有怪物受到精髓囚禁'], scope: 'global', effects: [{ stat: 'essences', percent: 40 }] },
  { id: 'voy-fracture', short: '50% 稀有怪碎裂', text: '50% chance for Rare Monsters to Fracture on death', zh: '稀有怪物死亡时有 50% 几率碎裂', aliases: ['航程內的稀有怪物有 50% 機率於死亡時散裂'], scope: 'global', effects: [{ stat: 'rares', percent: 50 }] },
  { id: 'voy-flask', short: '20% 药剂品质', text: 'Flasks found in all Voyage Areas have 100% chance to have 20% Quality', zh: '所有航行区域发现的药剂有 100% 几率拥有 20% 品质', aliases: ['航程中所有區域內找到的藥劑有 100% 機率擁有 20% 品質'], scope: 'global', effects: [] },
]
