...
export interface ChartAreaDefinition {
  ...
  chinese?: string
  /** Traditional-Chinese (TW client) name - converted candidates, unverified */
  traditional?: string
}
...
export const CHART_AREAS = [
  { id: 'anchorfield', english: 'Anchorfield', korean: '정박장', chinese: '锚地', traditional: '錨地' },
  {
  ...
  { id: 'diving-shoals', english: 'Diving Shoals', korean: '잠수 모래톱', chinese: '深海浅滩', traditional: '深海淺灘' },
  { id: 'eldritch-depths', english: 'Eldritch Depths', korean: '섬뜩한 지하', chinese: '古灵深渊', traditional: '古靈深淵' },
  {
    id: 'hazardous-depths',
  ...
  { id: 'lost-ruins', english: 'Lost Ruins', korean: '잃어버린 폐허', chinese: '失落遗迹', traditional: '失落遺跡' },
  { id: 'abyssal-plain', english: 'Abyssal Plain', korean: '심연의 평야', chinese: '深海平原', traditional: '深海平原' },
  { id: 'pelagic-abyss', english: 'Pelagic Abyss', korean: '원양 심연', chinese: '远洋深渊', traditional: '遠洋深淵' },
  { id: 'seafloor-ridges', english: 'Seafloor Ridges', korean: '해저 마루', chinese: '海底山脊', traditional: '海底山脊' },
  { id: 'sea-pillars', english: 'Sea Pillars', korean: '바다 기둥', chinese: '海之柱', traditional: '海之柱' },
  { id: 'sunken-totems', english: 'Sunken Totems', korean: '가라앉은 토템', chinese: '沉没图腾', traditional: '沉沒圖騰' },
  { id: 'undersea-groves', english: 'Undersea Groves', korean: '바다 밑 숲', chinese: '海底幽林', traditional: '海底幽林' },
  { id: 'kisharas-rest', english: "Kishara's Rest", korean: '키샤라의 안식처', chinese: '基莎拉之憩', traditional: '基莎拉之憩' },
...
for (const area of CHART_AREAS) {
  ...
  if (area.traditional) chartAreaByAlias.set(normalize(area.traditional), area.id)
}
